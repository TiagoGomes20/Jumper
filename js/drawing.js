...
game.redraw = function () {
	...
	game.counter.innerHTML = "Made by: Tiago Gomes | Controlos: W, D / setas e SPACE | Pontos: " + Math.round(-game.player.highestY / (3 * game.options.tileHeight)), game.canvas.width - 50, game.canvas.height - 12
}
...
game.requestRedraw = function () {
	...
	if(game.isOver) {
		...
		game.context.fillText("Perdeste!", game.canvas.width / 2, game.canvas.height / 2)
		game.context.font = "15px Georgia"
		game.context.fillText("(Clica F5 para jogar de novo)", game.canvas.width / 2, game.canvas.height / 2 + 50)
	}
}
